...
func main() {
	...
	log.Fatal(http.ListenAndServeTLS(hostPort, "/etc/letsencrypt/live/wallet.zent.cash/fullchain.pem", "/etc/letsencrypt/live/wallet.zent.cash/privkey.pem", router))
}
...
func walletKeys(res http.ResponseWriter, req *http.Request, _ httprouter.Params) {
	...
	}{User: userInfo{Username: usr.Username, Address: usr.Address}, Keys: keys.Data}
